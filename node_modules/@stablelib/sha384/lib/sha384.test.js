...
describe("sha384.SHA384", function () {
    ...
    it("should return 48-byte digest", function () {
        var h = new sha384_1.SHA384();
        h.update(input);
        expect(h.digest().length).toBe(48);
    });
});
describe("sha384.hash", function () {
    it("should produce correct hashes for test vectors", function () {
        for (var i = 0; i < input.length; i++) {
            var digest = sha384_1.hash(input.subarray(0, i));
